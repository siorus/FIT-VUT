...
?>
    ...
    <form class="form-horizontal" role="form" method="post" action="menu_polozka_ingred_add_script.php?id=<?php echo $id; ?>&nazev=<?php echo htmlspecialchars($nazev_pol); ?>">
    <fieldset>
        <?php
                ...
                <?php 
                    ...
                    if ($result = mysqli_query($db, $query)) {
                        while ($row_a = mysqli_fetch_assoc($result)){
                            echo "<option value=";
                            echo htmlspecialchars($row_a['id_ingredience']);
                            echo ">";
        ...
        <div class="col-sm-offset-3 col-sm-3 col-sm-offset-3 center-block">
        <button type="submit" id="submit" name="submit" class="btn-lg btn-success">Přidat</button>
        <button type='button' class='btn-lg btn-primary' onclick="window.location.href = '/menu_polozka.php'">Ukončení přidávání</button>
      </div>
